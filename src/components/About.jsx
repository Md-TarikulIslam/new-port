...
export default function About() {
    return (
        <div className="max-w-screen-xl mx-auto px-2 lg:px-0" id="about">
            <div className="mb-3 text-blue-900">About Me</div>
                ...
                <figcaption className="absolute bottom-8 left-2/4 flex w-full lg:w-[calc(100%-4rem)] -translate-x-2/4 justify-between rounded-xl border border-white bg-white/75 py-4 px-2  lg:px-6 shadow-lg shadow-black/5 saturate-200 backdrop-blur-sm">
                    <div className="">
                        <div className="flex gap-3 justify-center lg:justify-start">
                            <div className="h-24 w-24 lg:h-36 lg:w-36 border border-orange-600 p-1 lg:p-4 rounded-xl flex flex-col items-center hover:bg-orange-600 hover:text-white">
                        ...
                        <Typography color="gray" className="my-2 font-normal text-justify  mx-auto">
                        ...
                        <a href="https://drive.google.com/uc?id=1a19KFmNoYVRvmXOH_tv0F9lmeuMVn0rj&export=download"
                            download><Button className="flex items-center gap-2 bg-blue-900 hover:bg-black">Download CV <FcNews className="text-xl" /></Button></a>
                    </div>
